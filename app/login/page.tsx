      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-20">
        <div className="bg-white p-10 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-2xl w-full max-w-md border border-stone-100">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-serif font-bold mb-3 text-stone-900">Welcome Back</h1>
          ...
          >
            ...
            <span className="group-hover:text-black transition">Continue with Google</span>
          </button>

          <div className="relative flex py-5 items-center">
            <div className="flex-grow border-t border-stone-200"></div>
            <span className="flex-shrink mx-4 text-stone-400 text-xs uppercase tracking-widest">Or login with email</span>
            <div className="flex-grow border-t border-stone-200"></div>
          </div>
